...
int main(int argc, char *argv[]) {
	int n=6; // valor a modificar segun el caso!! (n numero de filas) numero de datos******
	int bandera=1; //bandera para validar los puntos
	int grado=2; // grado del polinomio deseado //modificar segun el caso****************
	double x[6] = {0.2,0.6,1.3,1.4,1.8,2};
	double y[6] = {-0.94,-0.26,2.35,2.94,5.45,7.2};
